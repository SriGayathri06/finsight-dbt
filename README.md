...
### 📋 Milestone 5 — Semi-structured Data (Planned)
- [ ] Ingest JSON transaction data via Snowflake VARIANT column
- [ ] Flatten nested JSON in dbt staging models
- [ ] Extend marts to include JSON-sourced transactions
